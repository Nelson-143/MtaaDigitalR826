        ...
        <div class="stg-container">
            ...
            <section class="backlight-bottom">
                ...
                <div class="stg-row stg-bottom-gap-l">
                    <div class="stg-col-8">
                        <h1 class="stg-bottom-gap" data-split-appear="fade-up" data-split-unload="fade-up">Here, your burning 🔥 questions about Mtaa Digital get answered!</h1>
                    </div>
                ...
                <div class="bringer-parallax-media stg-bottom-gap-l" data-appear="fade-up" data-unload="fade-out">
                    <img class="bringer-lazy" src="img/null.png" data-src="{{ asset('frontend/assets/img/inner-pages/qnn.jpg') }}" alt="Questions and Answers" width="1920" height="960">
                </div>
